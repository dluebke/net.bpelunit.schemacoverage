...
public class MeasurementPointBuilderTest {
	...
	public void testSubstitutionElement() {
		...
		assertTrue(measurementPoints.toString(), mpAsStrings.contains("MandatoryNodeUsed:count(/{http://www.example.org/MeasurementBuilderTest}Parent)[=1]"));
		...
		assertTrue(measurementPoints.toString(), mpAsStrings.contains("MandatoryNodeUsed:count(/{http://www.example.org/MeasurementBuilderTest}Substitute)[=1]"));
	...
	public void testInheritanceElement() {
		...
		assertTrue(measurementPoints.toString(), mpAsStrings.contains("MandatoryNodeUsed:count(/{http://www.example.org/MeasurementBuilderTest}X)[=1]"));
	...
	public void testNestedInlineTypes() throws Exception {
		...
		assertTrue(measurementPoints.toString(), mpAsStrings.contains("MandatoryNodeUsed:count(/{http://www.example.org/SchemaWithNestedInlineType}B)[=1]"));
		assertTrue(measurementPoints.toString(), mpAsStrings.contains("MandatoryNodeUsed:count(/{http://www.example.org/SchemaWithNestedInlineType}B)[=1]"));
